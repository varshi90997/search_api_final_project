class ApiModel {
  ...
  ApiModel({this.queryStatistics, this.totalPages, this.currentPageIndex, this.totalRecords, this.returnedRecords, this.items});

  ApiModel.fromJson(Map<String, dynamic> json) {
    queryStatistics = json['queryStatistics'] != null ? QueryStatistics.fromJson(json['queryStatistics']) : null;
...
Items({this.title, this.isTrusted, this.type, this.description, this.thumbnailUrl, this.entityId, this.referenceCount});
